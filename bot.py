...
MAX_PRICE_IPHONE_11 = 3000   # ТЕСТОВО (потім поставиш 300)
MAX_PRICE_IPHONE_13 = 9500   # ТЕСТОВО (потім поставиш 950)
...
# 🔔 ТЕСТОВЕ ПОВІДОМЛЕННЯ (МАЄ ПРИЙТИ ЗАВЖДИ)
send("✅ iPhone bot успішно запустився")
